...
Функционал: Фильтрация и поиск товаров в каталоге на сайте Регард
  ...
  Сценарий: Выбираем товары по минимальной цене с фильтрацией по производителю
    ...
    Тогда Открываем раздел "Периферия" в каталоге и показываем ошибку, если он не найден
    И Выбираем категорию "Клавиатуры" в разделе
    И Вводим значение цены мин От "2000" рублей
